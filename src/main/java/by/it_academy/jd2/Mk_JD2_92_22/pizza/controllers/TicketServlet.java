...
public class TicketServlet extends HttpServlet {
    ...
    public TicketServlet() {
        this.service = TicketServiceSingleton.getInstance();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (queryString == null) {
                ...
                List<ITicket> items = service.get();
                writer.write(this.mapper.writeValueAsString(items));

            } else {

                long id = Integer.parseInt(req.getParameter(ID));
                ITicket item = service.read(id);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            TicketDto itemDto = this.mapper.readValue(req.getInputStream(), TicketDto.class);

            ITicket item = this.service.create(itemDto);
